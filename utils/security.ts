...
/**
 * 🛡️ SENTINEL: Centralized administrative access check.
 * Checks if a user has any of the administrative roles.
 */
export const hasAdministrativeAccess = (user?: User): boolean => {
