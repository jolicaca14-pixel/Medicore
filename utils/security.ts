...
/**
 * 🛡️ Access Control: Check if a user has administrative roles.
 * Includes ADMIN, MANAGER, and ACCOUNTANT.
 */
...
/**
 * 🛡️ Access Control: Strictly check for System Administrator role.
 */
