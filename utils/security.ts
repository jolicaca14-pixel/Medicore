...
/**
 * 🛡️ Sentinel: Role-Based Access Control Utility
 * Checks if the current user session has administrative roles.
 * Administrative roles typically include ADMIN, MANAGER, and ACCOUNTANT.
 */
