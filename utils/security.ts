...
/**
 * 🛡️ Sentinel: Administrative Access Check
 * Verifies if the user has administrative roles (ADMIN, MANAGER, or ACCOUNTANT).
 *
 * @param user The user to check.
 * @returns true if the user has administrative access.
 */
