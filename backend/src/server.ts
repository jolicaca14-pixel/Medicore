...
import clinicalRecordRoutes from './modulos/historias-clinicas/routes';
import prescriptionRoutes from './modulos/recetas/routes';
...
app.use('/api/historias-clinicas', clinicalRecordRoutes);
