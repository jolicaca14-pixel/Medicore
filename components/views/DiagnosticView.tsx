          ...
          <div key={field.id} className="col-span-1">
              ...
              {field.type === 'TEXTAREA' ? (
                  ...
                  <div className="relative">
                      <label className="border-2 border-dashed border-slate-300 rounded p-4 text-center cursor-pointer hover:bg-slate-50 hover:border-blue-400 transition-colors flex flex-col items-center justify-center">
      ...
      printWindow.document.write(`
          ...
          <head>
              ...
              <style>
                  ...
                  .header { text-align: center; border-bottom: 2px solid #e2e8f0; margin-bottom: 30px; padding-bottom: 10px; }
                  .result-card { border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px; margin-bottom: 20px; }
                  .result-title { font-weight: bold; font-size: 1.1rem; border-bottom: 1px solid #f1f5f9; padding-bottom: 8px; margin-bottom: 15px; }
                  .field { display: flex; margin-bottom: 5px; }
                  .field-label { width: 200px; font-weight: bold; color: #64748b; }
              </style>
          </head>
          <body>
              <div class="header">
                  <h1>MEDICORE IPS</h1>
                  <p>Laboratorio y Apoyo Diagnóstico</p>
              ...
              ${recordsToPrint.map(r => `
                  <div class="result-card">
                      ...
                      ${Object.entries(r.dynamicData).map(([key, val]) => {
                          ...
                          return `<div class="field"><span class="field-label">${label}:</span><span>${val}</span></div>`;
                      }).join('')}
                  </div>
              `).join('')}
              <div style="margin-top: 50px; border-top: 1px solid #e2e8f0; pt-20">
