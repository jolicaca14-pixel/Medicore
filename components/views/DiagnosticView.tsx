        ...
        <html>
          <head>
            ...
            <style>
              ...
              .patient-info { background: #f8fafc; padding: 15px; border-radius: 8px; margin-bottom: 25px; display: grid; grid-template-columns: 1fr 1fr; gap: 10px; }
              .result-card { border: 1px solid #e2e8f0; border-radius: 12px; padding: 20px; margin-bottom: 20px; }
              .result-title { font-weight: bold; color: #1e293b; border-bottom: 1px solid #f1f5f9; padding-bottom: 8px; margin-bottom: 15px; text-transform: uppercase; }
          ...
          <body>
              ...
              <div class="result-card">
                ...
                <div class="fields">
                  ${Object.entries(r.dynamicData).map(([key, val]) => `
                    <div class="field">
                      <div class="label">${MOCK_SECTION_LIBRARY.flatMap(s => s.fields).find(f => f.id === key)?.label || key}:</div>
            ...
            <div class="footer">
              Este documento es una representación digital de resultados diagnósticos.
              Validado por: ${user.name} - Lic: ${user.professionalLicense || 'N/A'}
            </div>
