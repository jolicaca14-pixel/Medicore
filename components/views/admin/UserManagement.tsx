...
import { MOCK_USERS, roleLabels } from '../../../constants';
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 flex flex-col">
                <div className="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p className="text-sm text-slate-500">Gestiona el acceso y los roles del personal.</p>
                    </div>
                    <button onClick={handleAddNewUser} className="px-4 py-2 bg-slate-900 text-white text-sm font-bold rounded-lg flex items-center shadow-md hover:bg-slate-800 transition-colors">
                        <Plus size={16} className="mr-2"/> Agregar Usuario
                    </button>
                </div>
