                    ...
                    <table className="w-full text-sm text-left">
                        <thead className="bg-slate-50 text-slate-500 font-medium">
                            <tr>
                                ...
                                <th className="p-4">Género / Edad</th>
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {patients
                                ...
                                <tr key={p.id} className="hover:bg-slate-50">
                                    ...
                                    <td className="p-4">
                                        {p.gender} / {new Date().getFullYear() - new Date(p.birthDate).getFullYear()} años
                                    </td>
                                    <td className="p-4">
                                    ...
                                    <td className="p-4 text-right">
                                        <button
                                            ...
                                            className="text-blue-600 hover:bg-blue-50 px-3 py-1 rounded text-xs font-bold border border-blue-200"
                                        >
                                            Facturar
                                        </button>
                                    </td>
