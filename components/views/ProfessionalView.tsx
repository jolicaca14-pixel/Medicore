...
export const ProfessionalView: React.FC<ProfessionalViewProps> = ({ user, activeTab = 'dashboard' }) => {
  ...
  const handleSaveDraft = async () => {
    ...
    // Combine dynamic data with calculated values
    const recordToSave = {
      ...currentRecord,
    ...
    try {
        ...
        if (savedRecord.id && savedRecord.id !== currentRecord.id) {
  ...
  const handleDownloadContract = () => {
      ...
      alert('Iniciando descarga segura de contrato laboral. Por favor espere...');
  };
                              ...
                              <div className="border-t pt-4">
                                  ...
                                  <div className="space-y-2">
                                      <div className="flex items-center justify-between p-2 bg-slate-50 rounded border border-dashed border-slate-300">
                                          ...
                                          <button onClick={() => alert('Selector de archivos abierto: Seleccione Planilla SS.')} className="text-xs bg-white border px-2 py-1 rounded hover:bg-slate-100">Seleccionar...</button>
                                      </div>
                                      <div className="flex items-center justify-between p-2 bg-slate-50 rounded border border-dashed border-slate-300">
                                          <div className="flex items-center">
                                              <FileText size={16} className="text-slate-400 mr-2"/>
                                          ...
                                          <button onClick={() => alert('Selector de archivos abierto: Seleccione Informe Act.')} className="text-xs bg-white border px-2 py-1 rounded hover:bg-slate-100">Seleccionar...</button>
                                      </div>
                                  </div>
                              </div>
                          </div>
