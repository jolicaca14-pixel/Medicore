                                  ...
                                  <div className="space-y-2">
                                      <div className="flex items-center justify-between p-2 bg-slate-50 rounded border border-dashed border-slate-300">
                                          ...
                                          <label className="text-xs bg-white border px-2 py-1 rounded hover:bg-slate-100 cursor-pointer">
                                              Seleccionar...
                                              <input type="file" className="hidden" onChange={() => showStatus('Archivo "Seguridad Social" seleccionado.')} />
                                          </label>
                                      </div>
                                      <div className="flex items-center justify-between p-2 bg-slate-50 rounded border border-dashed border-slate-300">
                                          <div className="flex items-center">
                                          ...
                                          <label className="text-xs bg-white border px-2 py-1 rounded hover:bg-slate-100 cursor-pointer">
                                              Seleccionar...
                                              <input type="file" className="hidden" onChange={() => showStatus('Archivo "Informe de Actividades" seleccionado.')} />
                                          </label>
                                      </div>
                                  </div>
                              </div>
