                                      ...
                                      <div className="flex items-center justify-between p-2 bg-slate-50 rounded border border-dashed border-slate-300">
                                          <div className="flex items-center">
                                              ...
                                              <span className="text-xs text-slate-600">
                                                  ...
                                                  {newPayment.files.includes('ss.pdf') && <span className="ml-2 text-green-600 font-bold">✓</span>}
                                              </span>
                                          </div>
                                          <button onClick={() => setNewPayment(prev => ({ ...prev, files: [...prev.files, 'ss.pdf'] }))} className="text-xs bg-white border px-2 py-1 rounded hover:bg-slate-100">Seleccionar...</button>
                                      </div>
                                      <div className="flex items-center justify-between p-2 bg-slate-50 rounded border border-dashed border-slate-300">
                                          <div className="flex items-center">
                                              <FileText size={16} className="text-slate-400 mr-2"/>
                                              <span className="text-xs text-slate-600">
                                                  ...
                                                  {newPayment.files.includes('actividades.pdf') && <span className="ml-2 text-green-600 font-bold">✓</span>}
                                              </span>
                                          </div>
                                          <button onClick={() => setNewPayment(prev => ({ ...prev, files: [...prev.files, 'actividades.pdf'] }))} className="text-xs bg-white border px-2 py-1 rounded hover:bg-slate-100">Seleccionar...</button>
                                      </div>
                                  </div>
                              </div>
                          </div>
