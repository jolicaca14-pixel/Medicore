...
import { Search, Save, Lock, Bot, Clock, AlertCircle, ChevronRight, Activity, Calculator, Trash2, Printer, X, Stethoscope, DollarSign, FileCheck, AlertTriangle, ShieldCheck, Database, ListPlus, Syringe, History, TrendingUp, Briefcase, FileSignature, AlertOctagon, Copy, Loader2 } from 'lucide-react';
