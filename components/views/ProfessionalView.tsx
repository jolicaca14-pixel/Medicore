...
export const ProfessionalView: React.FC<ProfessionalViewProps> = ({ user, activeTab = 'dashboard' }) => {
  ...
  const handleDownloadContract = () => {
      ...
      const contractText = `CONTRATO DE PRESTACIÓN DE SERVICIOS\nPROFESIONAL: ${user.name}\nDOCUMENTO: ${user.documentNumber}\nFECHA: ${new Date().toLocaleDateString()}\n\nEste es un documento generado automáticamente que simula su contrato vigente en MediCore Pro.`;
                              ...
                              <div className="border-t pt-4">
                                  ...
                                  <div className="space-y-2">
                                      <div className="flex items-center justify-between p-2 bg-slate-50 rounded border border-dashed border-slate-300">
                                          ...
                                          <button
                                            onClick={() => setNewPayment({...newPayment, files: [...newPayment.files, 'seguridad_social.pdf']})}
                                      ...
                                      <div className="flex items-center justify-between p-2 bg-slate-50 rounded border border-dashed border-slate-300">
                                          ...
                                          <button
                                            onClick={() => setNewPayment({...newPayment, files: [...newPayment.files, 'informe_actividades.pdf']})}
                                            className="text-xs bg-white border px-2 py-1 rounded hover:bg-slate-100"
                                          >
