                              ...
                              <div className="border-t pt-4">
                                  ...
                                  <div className="space-y-2">
                                      <div className="flex items-center justify-between p-2 bg-slate-50 rounded border border-dashed border-slate-300">
                                          ...
                                          <button onClick={() => setNewPayment(prev => ({ ...prev, files: [...prev.files, 'Seguridad_Social.pdf'] }))} className={`text-xs border px-2 py-1 rounded transition-colors ${newPayment.files.includes('Seguridad_Social.pdf') ? 'bg-green-100 text-green-700 border-green-200' : 'bg-white hover:bg-slate-100'}`}>
                                      ...
                                      <div className="flex items-center justify-between p-2 bg-slate-50 rounded border border-dashed border-slate-300">
                                          ...
                                          <button onClick={() => setNewPayment(prev => ({ ...prev, files: [...prev.files, 'Informe_Actividades.pdf'] }))} className={`text-xs border px-2 py-1 rounded transition-colors ${newPayment.files.includes('Informe_Actividades.pdf') ? 'bg-green-100 text-green-700 border-green-200' : 'bg-white hover:bg-slate-100'}`}>
