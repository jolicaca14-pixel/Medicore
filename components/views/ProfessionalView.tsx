                              ...
                              <div className="border-t pt-4">
                                  ...
                                  <div className="space-y-2">
                                      <div className="flex items-center justify-between p-2 bg-slate-50 rounded border border-dashed border-slate-300">
                                          ...
                                          <button onClick={() => { setFileStatusMessage('Planilla cargada correctamente'); setTimeout(() => setFileStatusMessage(null), 3000); }} className="text-xs bg-white border px-2 py-1 rounded hover:bg-slate-100">Seleccionar...</button>
                                      </div>
                                      <div className="flex items-center justify-between p-2 bg-slate-50 rounded border border-dashed border-slate-300">
                                          <div className="flex items-center">
                                              <FileText size={16} className="text-slate-400 mr-2"/>
                                          ...
                                          <button onClick={() => { setFileStatusMessage('Informe cargado correctamente'); setTimeout(() => setFileStatusMessage(null), 3000); }} className="text-xs bg-white border px-2 py-1 rounded hover:bg-slate-100">Seleccionar...</button>
                                      </div>
                                  </div>
                              </div>
                              {fileStatusMessage && (
                                <div className="mt-2 p-2 bg-green-50 text-green-700 text-[10px] font-bold rounded border border-green-200 animate-in fade-in">
                                    <CheckCircle size={10} className="inline mr-1"/> {fileStatusMessage}
                                </div>
                              )}
                          </div>
