  ...
  const FormContent = () => (
    <>
      <div className="grid grid-cols-2 gap-4">
        ...
        {error && (
            <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded-lg flex items-center text-red-700 text-sm font-bold animate-in fade-in slide-in-from-top-1">
